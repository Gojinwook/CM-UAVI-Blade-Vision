...
class CInspectViewExtra1Dlg : public CDialog
{
	private:
	void	SetPosition(int left, int top, int right, int bottom) { m_ScreenRect = CRect(left, top, right, bottom); }
	CRect	m_ScreenRect;
	static CInspectViewExtra1Dlg	*m_pInstance;

public:
	static	CInspectViewExtra1Dlg* GetInstance(BOOL bShowFlag=FALSE);
	void	DeleteInstance();
...
// Construction
public:
	CInspectViewExtra1Dlg(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CInspectViewExtra1Dlg)
	enum { IDD = IDD_INSPECT_VIEW_EXTRA1_DLG };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CInspectViewExtra1Dlg)
	protected:
