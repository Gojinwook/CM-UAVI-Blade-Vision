// ConditionTopBarrelDlg.cpp : 구현 파일입니다.
//
...
IMPLEMENT_DYNAMIC(CConditionTopBarrelDlg, CDialog)

CConditionTopBarrelDlg::CConditionTopBarrelDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CConditionTopBarrelDlg::IDD, pParent)
{

}

CConditionTopBarrelDlg::~CConditionTopBarrelDlg()
{
}

void CConditionTopBarrelDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(CConditionTopBarrelDlg, CDialog)
END_MESSAGE_MAP()


// CConditionTopBarrelDlg 메시지 처리기입니다.

BOOL CConditionTopBarrelDlg::OnInitDialog()
{
