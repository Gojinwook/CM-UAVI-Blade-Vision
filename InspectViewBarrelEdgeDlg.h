...
class CInspectViewBarrelEdgeDlg : public CDialog
{
	private:
	void	SetPosition(int left, int top, int right, int bottom) { m_ScreenRect = CRect(left, top, right, bottom); }
	CRect	m_ScreenRect;
	static CInspectViewBarrelEdgeDlg	*m_pInstance;

public:
	static	CInspectViewBarrelEdgeDlg* GetInstance(BOOL bShowFlag=FALSE);
	void	DeleteInstance();
...
// Construction
public:
	CInspectViewBarrelEdgeDlg(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CInspectViewBarrelEdgeDlg)
	enum { IDD = IDD_INSPECT_VIEW_BARREL_EDGE_DLG };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CInspectViewBarrelEdgeDlg)
	protected:
...
protected:
	...
	//{{AFX_MSG(CInspectViewBarrelEdgeDlg)
