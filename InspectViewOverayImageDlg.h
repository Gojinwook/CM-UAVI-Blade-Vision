...
class CInspectViewOverayImageDlg : public CDialog
{
	private:
	void	SetPosition(int left, int top, int right, int bottom) { m_ScreenRect = CRect(left, top, right, bottom); }
	CRect	m_ScreenRect;
	static CInspectViewOverayImageDlg	*m_pInstance;

public:
	static	CInspectViewOverayImageDlg* GetInstance(BOOL bShowFlag=FALSE);
	void	DeleteInstance();
...
// Construction
public:
	CInspectViewOverayImageDlg(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CInspectViewOverayImageDlg)
	enum { IDD = IDD_INSPECT_VIEW_OVERAY_IMAGE };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CInspectViewOverayImageDlg)
	protected:
...
protected:
	...
	//{{AFX_MSG(CInspectViewOverayImageDlg)
