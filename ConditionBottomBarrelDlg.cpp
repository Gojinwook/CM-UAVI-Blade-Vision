// ConditionBottomBarrelDlg.cpp : 구현 파일입니다.
//
...
IMPLEMENT_DYNAMIC(CConditionBottomBarrelDlg, CDialog)

CConditionBottomBarrelDlg::CConditionBottomBarrelDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CConditionBottomBarrelDlg::IDD, pParent)
{

}

CConditionBottomBarrelDlg::~CConditionBottomBarrelDlg()
{
}

void CConditionBottomBarrelDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(CConditionBottomBarrelDlg, CDialog)
END_MESSAGE_MAP()


// CConditionBottomBarrelDlg 메시지 처리기입니다.

BOOL CConditionBottomBarrelDlg::OnInitDialog()
{
