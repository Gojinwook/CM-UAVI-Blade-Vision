...
IMPLEMENT_DYNAMIC(CROIAlgorithmCommonDlg, CDialog)

void CROIAlgorithmCommonDlg::Show()
{
	ShowWindow(SW_SHOW);
}

void CROIAlgorithmCommonDlg::Hide()
{
	ShowWindow(SW_HIDE);
}

CROIAlgorithmCommonDlg::CROIAlgorithmCommonDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CROIAlgorithmCommonDlg::IDD, pParent)
{
...
CROIAlgorithmCommonDlg::~CROIAlgorithmCommonDlg()
{
}

void CROIAlgorithmCommonDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CROIAlgorithmCommonDlg, CDialog)
	ON_BN_CLICKED(IDC_BUTTON_AREA_MIN, &CROIAlgorithmCommonDlg::OnBnClickedButtonAreaMin)
	ON_BN_CLICKED(IDC_BUTTON_AREA_MAX, &CROIAlgorithmCommonDlg::OnBnClickedButtonAreaMax)
	ON_BN_CLICKED(IDC_BUTTON_LENGTH_MIN, &CROIAlgorithmCommonDlg::OnBnClickedButtonLengthMin)
	ON_BN_CLICKED(IDC_BUTTON_LENGTH_MAX, &CROIAlgorithmCommonDlg::OnBnClickedButtonLengthMax)
	ON_BN_CLICKED(IDC_BUTTON_WIDTH_MIN, &CROIAlgorithmCommonDlg::OnBnClickedButtonWidthMin)
	ON_BN_CLICKED(IDC_BUTTON_WIDTH_MAX, &CROIAlgorithmCommonDlg::OnBnClickedButtonWidthMax)
	ON_BN_CLICKED(IDC_BUTTON_MEAN_MIN, &CROIAlgorithmCommonDlg::OnBnClickedButtonMeanMin)
	ON_BN_CLICKED(IDC_BUTTON_MEAN_MAX, &CROIAlgorithmCommonDlg::OnBnClickedButtonMeanMax)
	ON_BN_CLICKED(IDC_BUTTON_STDEV_MIN, &CROIAlgorithmCommonDlg::OnBnClickedButtonStdevMin)
	ON_BN_CLICKED(IDC_BUTTON_STDEV_MAX, &CROIAlgorithmCommonDlg::OnBnClickedButtonStdevMax)
	ON_BN_CLICKED(IDC_BUTTON_ANISOMETRY_MIN, &CROIAlgorithmCommonDlg::OnBnClickedButtonAnisometryMin)
	ON_BN_CLICKED(IDC_BUTTON_ANISOMETRY_MAX, &CROIAlgorithmCommonDlg::OnBnClickedButtonAnisometryMax)
	ON_BN_CLICKED(IDC_BUTTON_CIRCULARITY_MIN, &CROIAlgorithmCommonDlg::OnBnClickedButtonCircularityMin)
	ON_BN_CLICKED(IDC_BUTTON_CIRCULARITY_MAX, &CROIAlgorithmCommonDlg::OnBnClickedButtonCircularityMax)
	ON_BN_CLICKED(IDC_BUTTON_CONVEXITY_MIN, &CROIAlgorithmCommonDlg::OnBnClickedButtonConvexityMin)
	ON_BN_CLICKED(IDC_BUTTON_CONVEXITY_MAX, &CROIAlgorithmCommonDlg::OnBnClickedButtonConvexityMax)
	ON_BN_CLICKED(IDC_BUTTON_ELLIPSE_RATIO_MIN, &CROIAlgorithmCommonDlg::OnBnClickedButtonEllipseRatioMin)
	ON_BN_CLICKED(IDC_BUTTON_ELLIPSE_RATIO_MAX, &CROIAlgorithmCommonDlg::OnBnClickedButtonEllipseRatioMax)
	ON_BN_CLICKED(IDC_BUTTON_DISPLAY_SCALED_IMAGE, &CROIAlgorithmCommonDlg::OnBnClickedButtonDisplayScaledImage)
	ON_BN_CLICKED(IDC_BUTTON_X_LENGTH_MIN, &CROIAlgorithmCommonDlg::OnBnClickedButtonXLengthMin)
	ON_BN_CLICKED(IDC_BUTTON_X_LENGTH_MAX, &CROIAlgorithmCommonDlg::OnBnClickedButtonXLengthMax)
	ON_BN_CLICKED(IDC_BUTTON_Y_LENGTH_MIN, &CROIAlgorithmCommonDlg::OnBnClickedButtonYLengthMin)
	ON_BN_CLICKED(IDC_BUTTON_Y_LENGTH_MAX, &CROIAlgorithmCommonDlg::OnBnClickedButtonYLengthMax)
	ON_BN_CLICKED(IDC_BUTTON_CONTRAST_MIN, &CROIAlgorithmCommonDlg::OnBnClickedButtonContrastMin)
	ON_BN_CLICKED(IDC_BUTTON_CONTRAST_MAX, &CROIAlgorithmCommonDlg::OnBnClickedButtonContrastMax)
	ON_BN_CLICKED(IDC_BUTTON_SET_LINE_FIT, &CROIAlgorithmCommonDlg::OnBnClickedButtonSetLineFit)
END_MESSAGE_MAP()
...
BOOL CROIAlgorithmCommonDlg::PreTranslateMessage(MSG* pMsg)
{
	switch (pMsg->message) {
...
BOOL CROIAlgorithmCommonDlg::OnInitDialog()
{
...
void CROIAlgorithmCommonDlg::SetSelectedInspection(int iImageType, GTRegion* pSelectedROI, int iTabIndex)
{
...
void CROIAlgorithmCommonDlg::SetParam(CAlgorithmParam pROIAlgorithmParam)
{
...
//0531
void CROIAlgorithmCommonDlg::GetParam(CAlgorithmParam* pROIAlgorithmParam)
{
	UpdateData();
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonAreaMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonAreaMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonLengthMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonLengthMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonWidthMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonWidthMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonMeanMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonMeanMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonStdevMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonStdevMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonAnisometryMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonAnisometryMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonCircularityMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonCircularityMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonConvexityMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonConvexityMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonEllipseRatioMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonEllipseRatioMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonDisplayScaledImage()
{
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonXLengthMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonXLengthMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonYLengthMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonYLengthMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonContrastMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonContrastMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIAlgorithmCommonDlg::OnBnClickedButtonSetLineFit()
{
