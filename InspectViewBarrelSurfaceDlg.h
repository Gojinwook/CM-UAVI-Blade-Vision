...
class CInspectViewBarrelSurfaceDlg : public CDialog
{
	private:
	void	SetPosition(int left, int top, int right, int bottom) { m_ScreenRect = CRect(left, top, right, bottom); }
	CRect	m_ScreenRect;
	static CInspectViewBarrelSurfaceDlg	*m_pInstance;

public:
	static	CInspectViewBarrelSurfaceDlg* GetInstance(BOOL bShowFlag=FALSE);
	void	DeleteInstance();
...
// Construction
public:
	CInspectViewBarrelSurfaceDlg(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CInspectViewBarrelSurfaceDlg)
	enum { IDD = IDD_INSPECT_VIEW_BARREL_SURFACE_DLG };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CInspectViewBarrelSurfaceDlg)
	protected:
...
protected:
	...
	//{{AFX_MSG(CInspectViewBarrelSurfaceDlg)
