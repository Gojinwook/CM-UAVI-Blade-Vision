...
class CROIAlgorithmCommonDlg : public CDialog
{
	DECLARE_DYNAMIC(CROIAlgorithmCommonDlg)

public:
	CROIAlgorithmCommonDlg(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~CROIAlgorithmCommonDlg();
	...
	// 대화 상자 데이터입니다.
	enum { IDD = IDD_TEACH_ROI_ALGORITHM_COMMON_DLG};

private:
	void	SetPosition(int left, int top, int right, int bottom) { m_ScreenRect = CRect(left, top, right, bottom); }
	CRect	m_ScreenRect;

	static CROIAlgorithmCommonDlg* m_pInstance;
