...
#include "stdafx.h"
#include "uScan.h"
#include "ROIInspAlgorithmDlg.h"
#include "afxdialogex.h"


// CROIInspAlgorithmDlg 대화 상자입니다.
IMPLEMENT_DYNAMIC(CROIInspAlgorithmDlg, CDialog)

void CROIInspAlgorithmDlg::Show()
{
	ShowWindow(SW_SHOW);
}

void CROIInspAlgorithmDlg::Hide()
{
	ShowWindow(SW_HIDE);
}

CROIInspAlgorithmDlg::CROIInspAlgorithmDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CROIInspAlgorithmDlg::IDD, pParent)
{
...
CROIInspAlgorithmDlg::~CROIInspAlgorithmDlg()
{
}

void CROIInspAlgorithmDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CROIInspAlgorithmDlg, CDialog)
	ON_BN_CLICKED(IDC_BUTTON_AREA_MIN, &CROIInspAlgorithmDlg::OnBnClickedButtonAreaMin)
	ON_BN_CLICKED(IDC_BUTTON_AREA_MAX, &CROIInspAlgorithmDlg::OnBnClickedButtonAreaMax)
	ON_BN_CLICKED(IDC_BUTTON_LENGTH_MIN, &CROIInspAlgorithmDlg::OnBnClickedButtonLengthMin)
	ON_BN_CLICKED(IDC_BUTTON_LENGTH_MAX, &CROIInspAlgorithmDlg::OnBnClickedButtonLengthMax)
	ON_BN_CLICKED(IDC_BUTTON_WIDTH_MIN, &CROIInspAlgorithmDlg::OnBnClickedButtonWidthMin)
	ON_BN_CLICKED(IDC_BUTTON_WIDTH_MAX, &CROIInspAlgorithmDlg::OnBnClickedButtonWidthMax)
	ON_BN_CLICKED(IDC_BUTTON_MEAN_MIN, &CROIInspAlgorithmDlg::OnBnClickedButtonMeanMin)
	ON_BN_CLICKED(IDC_BUTTON_MEAN_MAX, &CROIInspAlgorithmDlg::OnBnClickedButtonMeanMax)
	ON_BN_CLICKED(IDC_BUTTON_STDEV_MIN, &CROIInspAlgorithmDlg::OnBnClickedButtonStdevMin)
	ON_BN_CLICKED(IDC_BUTTON_STDEV_MAX, &CROIInspAlgorithmDlg::OnBnClickedButtonStdevMax)
	ON_BN_CLICKED(IDC_BUTTON_ANISOMETRY_MIN, &CROIInspAlgorithmDlg::OnBnClickedButtonAnisometryMin)
	ON_BN_CLICKED(IDC_BUTTON_ANISOMETRY_MAX, &CROIInspAlgorithmDlg::OnBnClickedButtonAnisometryMax)
	ON_BN_CLICKED(IDC_BUTTON_CIRCULARITY_MIN, &CROIInspAlgorithmDlg::OnBnClickedButtonCircularityMin)
	ON_BN_CLICKED(IDC_BUTTON_CIRCULARITY_MAX, &CROIInspAlgorithmDlg::OnBnClickedButtonCircularityMax)
	ON_BN_CLICKED(IDC_BUTTON_CONVEXITY_MIN, &CROIInspAlgorithmDlg::OnBnClickedButtonConvexityMin)
	ON_BN_CLICKED(IDC_BUTTON_CONVEXITY_MAX, &CROIInspAlgorithmDlg::OnBnClickedButtonConvexityMax)
	ON_BN_CLICKED(IDC_BUTTON_ELLIPSE_RATIO_MIN, &CROIInspAlgorithmDlg::OnBnClickedButtonEllipseRatioMin)
	ON_BN_CLICKED(IDC_BUTTON_ELLIPSE_RATIO_MAX, &CROIInspAlgorithmDlg::OnBnClickedButtonEllipseRatioMax)
	ON_BN_CLICKED(IDC_BUTTON_DISPLAY_SCALED_IMAGE, &CROIInspAlgorithmDlg::OnBnClickedButtonDisplayScaledImage)
	ON_BN_CLICKED(IDC_BUTTON_X_LENGTH_MIN, &CROIInspAlgorithmDlg::OnBnClickedButtonXLengthMin)
	ON_BN_CLICKED(IDC_BUTTON_X_LENGTH_MAX, &CROIInspAlgorithmDlg::OnBnClickedButtonXLengthMax)
	ON_BN_CLICKED(IDC_BUTTON_Y_LENGTH_MIN, &CROIInspAlgorithmDlg::OnBnClickedButtonYLengthMin)
	ON_BN_CLICKED(IDC_BUTTON_Y_LENGTH_MAX, &CROIInspAlgorithmDlg::OnBnClickedButtonYLengthMax)
	ON_BN_CLICKED(IDC_BUTTON_CONTRAST_MIN, &CROIInspAlgorithmDlg::OnBnClickedButtonContrastMin)
	ON_BN_CLICKED(IDC_BUTTON_CONTRAST_MAX, &CROIInspAlgorithmDlg::OnBnClickedButtonContrastMax)
	ON_BN_CLICKED(IDC_BUTTON_SET_LINE_FIT, &CROIInspAlgorithmDlg::OnBnClickedButtonSetLineFit)
END_MESSAGE_MAP()
...
BOOL CROIInspAlgorithmDlg::PreTranslateMessage(MSG* pMsg)
{
	switch (pMsg->message) {
...
BOOL CROIInspAlgorithmDlg::OnInitDialog()
{
...
void CROIInspAlgorithmDlg::SetSelectedInspection(int iImageType, GTRegion* pSelectedROI, int iTabIndex)
{
...
void CROIInspAlgorithmDlg::SetParam(CAlgorithmParam pROIAlgorithmParam)
{
...
//0531
void CROIInspAlgorithmDlg::GetParam(CAlgorithmParam* pROIAlgorithmParam)
{
	UpdateData();
	...
	pROIAlgorithmParam->m_iUseDontCareImage = m_iSelectedImageType;	// 24.03.29 - v2645 - 검사제외영역 영상 번호 파라미터 추가 - LeeGW

	THEAPP.m_pTabControlDlg->UpdateROIList(m_iSelectedImageType, m_iInspectionType);
}


void CROIInspAlgorithmDlg::OnBnClickedButtonAreaMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonAreaMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonLengthMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonLengthMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonWidthMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonWidthMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonMeanMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonMeanMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonStdevMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonStdevMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonAnisometryMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonAnisometryMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonCircularityMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonCircularityMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonConvexityMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonConvexityMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonEllipseRatioMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonEllipseRatioMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonDisplayScaledImage()
{
...
void CROIInspAlgorithmDlg::OnBnClickedButtonXLengthMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonXLengthMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonYLengthMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonYLengthMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonContrastMin()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonContrastMax()
{
	UpdateData(TRUE);
	UpdateData(FALSE);
...
void CROIInspAlgorithmDlg::OnBnClickedButtonSetLineFit()
{
