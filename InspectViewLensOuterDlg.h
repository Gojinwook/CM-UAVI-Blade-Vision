...
class CInspectViewLensOuterDlg : public CDialog
{
	private:
	void	SetPosition(int left, int top, int right, int bottom) { m_ScreenRect = CRect(left, top, right, bottom); }
	CRect	m_ScreenRect;
	static CInspectViewLensOuterDlg	*m_pInstance;

public:
	static	CInspectViewLensOuterDlg* GetInstance(BOOL bShowFlag=FALSE);
	void	DeleteInstance();
...
// Construction
public:
	CInspectViewLensOuterDlg(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CInspectViewLensOuterDlg)
	enum { IDD = IDD_INSPECT_VIEW_LENS_OUTER_DLG };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CInspectViewLensOuterDlg)
	protected:
...
protected:
	...
	//{{AFX_MSG(CInspectViewLensOuterDlg)
