...
class CInspectViewLensInnerDlg : public CDialog
{
	private:
	void	SetPosition(int left, int top, int right, int bottom) { m_ScreenRect = CRect(left, top, right, bottom); }
	CRect	m_ScreenRect;
	static CInspectViewLensInnerDlg	*m_pInstance;

public:
	static	CInspectViewLensInnerDlg* GetInstance(BOOL bShowFlag=FALSE);
	void	DeleteInstance();
...
// Construction
public:
	CInspectViewLensInnerDlg(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CInspectViewLensInnerDlg)
	enum { IDD = IDD_INSPECT_VIEW_LENS_INNER_DLG };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CInspectViewLensInnerDlg)
	protected:
...
protected:
	...
	//{{AFX_MSG(CInspectViewLensInnerDlg)
